...
class EmployeeRepository {
    ...
    async selectOne(filter) {
        try {
            ...
            const query = Employee.findOne(filter);
            return await query.exec();
        } catch (err) {
            console.log(err);
        }
    ...
    async updateOne(id, data) {
        try {
            return await Employee.updateOne({ _id: id }, data);
        } catch (err) {
            console.log(err);
        }
    }
    ...
    async update(filter, data) {
        try {
            return await Employee.updateMany(filter, data);
        } catch (err) {
            console.log(err);
        }
    }
    async delete(id) {
        try {
            return await Employee.updateOne({ _id: id },{
                deleteAt: new Date()
            });
        } catch (err) {
            console.log(err);
    ...
    async deleteMany(filter) {
        try {
            return await Employee.updateOne(filter,{
                deleteAt: new Date()
            });
        } catch (err) {
            console.log(err);
